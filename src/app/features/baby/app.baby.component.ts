...
import { BabyModel } from 'src/app/model/baby';
import { UserInfo } from 'src/app/model/user-info';
import { AuthService } from 'src/app/service/auth-service/auth.service';
import { BabyService } from 'src/app/service/baby-service/baby.service';
...
export class AppBabyComponent implements OnInit, OnDestroy {
  ...
  constructor(
      ...
      updateBaby() {
        ...
        this.babyService.updateBaby(this.babyId, updateBabyRequest).subscribe(
